...
<head>
    ...
    <link rel="stylesheet" href="admin/vfm-style.css">
    <?php 
    ...
    <script type="text/javascript" src="admin/js/jquery-1.12.4.min.js"></script>
    <!--[if lt IE 9]>
    <script src="admin/js/html5.js" type="text/javascript"></script>
