<div class="row">
    <div class="col-md-12">
        <div class="box box-default box-solid">
            <div class="box-header with-border">
                <strong><?php echo $encodeExplorer->getString("actions"); ?></strong>
            </div>
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table statistics table-hover table-condensed" id="sortanalytics" width="100%">
                      <thead>
                          <tr>
                              <th><span class="sorta"><?php echo $encodeExplorer->getString("day"); ?></span></th>
                              <th><span>hh:mm:ss</span></th>
                              <th><span class="sorta"><?php echo $encodeExplorer->getString("user"); ?></span></th>
                              <th><span class="sorta"><?php echo $encodeExplorer->getString("action"); ?></span></th>
                              <th><span class="sorta"><?php echo $encodeExplorer->getString("type"); ?></span></th>
                              <th><span class="sorta"><?php echo $encodeExplorer->getString("file_name"); ?></span></th>
                          </tr>
                        </thead>
                        <tbody>
    <?php
    foreach ($logs as $log) { 
        $logfile = 'log/'.basename($log);
    ...
    foreach ($result as $key => $value) {
        ...
        foreach ($value as $kiave => $day) {
            ...
            <td><?php echo $encodeExplorer->getString(strtolower($day['action'])); ?></td>
    ...
    ?>
                        ...
                        <tfoot>
                            <tr>
                                <td><?php echo $encodeExplorer->getString("day"); ?></td>
                                <td>hh:mm:ss</span></td>
                                <td><?php echo $encodeExplorer->getString("user"); ?></td>
                                <td><?php echo $encodeExplorer->getString("action"); ?></td>
                                <td><?php echo $encodeExplorer->getString("type"); ?></td>
                                <td><?php echo $encodeExplorer->getString("item"); ?></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
