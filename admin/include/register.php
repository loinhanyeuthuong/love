...
*/
$customfields = false;
if (file_exists('admin/users/customfields.php')) {
    include 'admin/users/customfields.php';
}
/**
* Registration Mask
*/
if ($setUp->getConfig("registration_enable") == true) { ?>
    ...
    <script type="text/javascript" src="admin/js/registration.js"></script>
                    ...
                    <form id="regform" action="<?php print $encodeExplorer->makeLink(false, null, ""); ?>">
                        ...
                        <div id="login_bar" class="form-group">
                            ...
                            */
                            ...
                            <?php
                            $disclaimerfile = 'admin/registration-disclaimer.html';
