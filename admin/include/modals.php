...
<script type="text/javascript">
    ...
    var baselink = "admin/vfm-downloader.php?q=";
    <?php 
    } ?>
</script>
    ...
    */ 
    ...
    <link href="admin/js/videojs/video-js.min.css" rel="stylesheet">
    <script src="admin/js/videojs/video.min.js"></script>
    <script type="text/javascript">
    function loadVid(thislink, thislinkencoded, thisname, thisID, ext){
        if (ext == 'ogv') {
            ext = 'ogg';
        }
        var vidlink = 'admin/ajax/streamvid.php?vid=' + thislink;
