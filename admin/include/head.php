...
require_once 'admin/users/remember.php';
global $_REMEMBER;
$cookies = new Cookies();
...
require_once 'admin/translations/'.$encodeExplorer->lang.'.php';
...
require_once 'admin/users/token.php';
global $_TOKENS;
...
require_once 'admin/vfm-icons.php';
